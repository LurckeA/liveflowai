...
class ChordAnalyzer:
    ...
    templates to reduce false analyzer and chord over-classification.
    """
    ...
    def start_analyzer(self, duration=None):
        """
        Start chord analyzer from the microphone.
        """

        self.is_running = True
        self.prediction_history.clear()

        print("\nStarting chord analyzer...")
        ...
        try:
            ...
            print("\nStopping chord analyzer...")

        except Exception as e:
            print(f"Error in chord analyzer: {e}")

        finally:
            self.is_running = False
            print("=" * 50)
            print("Chord analyze stopped")
...
def detect_chords(audio_path, sample_rate=22050):
    """
    Convenience function for chord analysis.
    """
    ...
    return analyzer.detect_from_file(audio_path)